...
if (OpenTutorial == true)
		{
			...
			draw_text(600 , 600 ,$" Move with arrow keys or 'A' & 'D'  " );
			...
			draw_text(1500 , 600 ,$"The upper right corner will show" );
			draw_text(1500 , 700 ,$"The number of hearts  " );
			draw_text(1500 , 800 ,$"when dying will be -1." );
			draw_text(1500 , 900 ,$"When remaining 0, 'GameOver'  " );
